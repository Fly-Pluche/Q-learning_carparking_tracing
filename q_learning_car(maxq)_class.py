...
class QLearningAgent:
    ...
    def learn(self, state, action, reward, next_state):
        ...
        # print('self.learning_rate * (new_q - current_q)',self.learning_rate * (new_q - current_q))
    ...
    def get_action(self, state):
        if np.random.rand() < self.epsilon:
            ...
            action = self.arg_max(state_action, state)
        return action
    ...
    # Manhattan distance
    def abs(self, s, next_state):
        distance = abs(cord[s][0] - cord[next_state][0]) + abs(cord[s][1] - cord[next_state][1])
...
def main():
    ...
    for i in range(training_times):
        ...
        while True:
            ...
            next_state, rew = agent.step(action, s)
            # 更新Q表
